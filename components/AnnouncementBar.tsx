...
const AnnouncementBar = () => {
  ...
  const barContent = (
    <div className="relative w-full overflow-hidden py-2.5 select-none pr-8">
      ...
      {isVisible && (
        ...
        >
          ...
          <button
            ...
            className="absolute right-3 top-1/2 -translate-y-1/2 p-1.5 text-stone-400 hover:text-white transition-colors z-20 bg-stone-950/80 backdrop-blur-xs rounded-full border border-white/[0.05]"

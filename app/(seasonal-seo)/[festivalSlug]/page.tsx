...
const ROUTE_CATEGORY_PREFERENCES: Record<string, string[]> = {
  ...
  "hume-sauvage-vs-dior-sauvage": [
    "fresh spicy",
    "ambroxan",
    "woody",
    "versatile",
  ],
  "hume-aventus-vs-creed-aventus": [
    "fresh fruity",
    "pineapple",
    "smoky",
    "woody",
  ],
  "hume-baccarat-540-vs-baccarat-rouge-540": [
    "amber",
    "sweet",
    "airy",
    "unisex",
  ],
  "hume-ombre-leather-vs-tom-ford-ombre-leather": [
    "leather",
    "spicy",
    "smoky",
    "warm",
  ...
  "hume-tobacco-vanille-vs-tom-ford-tobacco-vanille": [
    "tobacco",
    "vanilla",
    "spicy",
    "warm",
  ],
  "hume-bleu-vs-bleu-de-chanel": [
    "woody aromatic",
    "fresh",
    "clean",
    "incense",
  ...
  "hume-dylan-blue-vs-versace-dylan-blue": [
    "fresh",
    "blue",
    "ambroxan",
    "daily wear",
  ...
  "hume-layton-vs-parfums-de-marly-layton": [
    "apple",
    "spicy",
    "amber",
    "luxury",
  ],
  "hume-jazz-club-vs-replica-jazz-club": [
    "boozy",
    "tobacco",
    "vanilla",
    "woody",
  ],
  "hume-by-the-fireplace-vs-replica-by-the-fireplace": [
    "smoky",
    "sweet",
    "cozy",
    "winter",
  ...
  "hume-red-tobacco-vs-mancera-red-tobacco": [
    "tobacco",
    "spicy",
    "intense",
    "night",
  ...
  "perfume-under-1000-vs-under-2000": [
    "mid-budget",
    "long lasting",
    "versatile",
    "value",
  ],
  "cheap-perfume-vs-expensive-perfume": [
    "value",
    "quality",
    "performance",
    "versatile",
  ...
  "budget-perfume-vs-luxury-perfume": [
    "value",
    "luxury feel",
    "long lasting",
    "versatile",
  ...
  "office-perfume-vs-party-perfume": [
    "office",
    "party",
    "projection",
    "occasion",
  ...
  "day-perfume-vs-night-perfume": [
    "daytime",
    "night",
    "projection",
    "intensity",
  ],
  "date-perfume-vs-daily-perfume": [
    "date night",
    "daily wear",
    "attractive",
    "clean",
  ...
  "long-lasting-vs-strong-perfume": [
    "longevity",
    "strong projection",
    "sillage",
    "performance",
  ...
  "projection-vs-longevity-perfume": [
    "projection",
    "longevity",
    "performance",
    "guide",
  ...
  "smell-like-millionaire-vs-normal-perfume": [
    "luxury",
    "amber",
    "woody",
    "smooth",
  ],
  "compliment-perfume-vs-regular-perfume": [
    "compliment",
    "mass appeal",
    "fresh",
    "balanced",
  ],
  "luxury-smell-vs-budget-perfume": [
    "luxury",
    "budget",
    "long lasting",
    "value",
  ...
  "bella-vita-skai-vs-armaf-club-de-nuit": [
    "fresh spicy",
    "woody",
    "projection",
    "men",
  ...
  "armaf-club-de-nuit-vs-creed-aventus": [
    "fresh fruity",
    "pineapple",
    "smoky",
    "woody",
  ],
  "rasasi-hawas-vs-versace-eros": [
    "sweet",
    "fresh",
    "party",
    "strong projection",
...
const tokenize = (value: string) =>
  normalizeText(value)
    ...
    .map((t) => t.trim())
    .filter(
      (t) => t.length > 1 && !["inspired", "perfume", "parfum"].includes(t),
    );
...
const scoreProductByPreferences = (
  ...
  (
    product.dbCategoryIds ??
    product.categoryIds ?? [product.categoryId]
  ).forEach((id) => categoryTokens.add(normalizeText(id)));
  ...
  return preferences.reduce((score, pref) => {
    ...
    if (
      Array.from(categoryTokens).some(
        (token) => token.includes(p) || p.includes(token),
      )
    ) {
      return score + 30;
    }
...
const getInspiredProductRecommendations = (
  ...
  const matched = products
    .map((product) => {
      ...
      const inspirationTokens = new Set(
        tokenize(`${product.inspirationBrand ?? ""} ${product.inspiration}`),
      );
      const tokenOverlap = targetTokens.filter((t) =>
        inspirationTokens.has(t),
      ).length;
      const exactBoost =
        inspirationLine.includes(target) || target.includes(inspirationLine)
          ? 100
          : 0;
      ...
      <section className="pt-28 pb-16">
        <div className="container-custom px-4 sm:px-6 lg:px-10">
          <p className="text-[10px] md:text-[11px] uppercase tracking-[0.2em] md:tracking-[0.22em] text-muted-foreground">
            Festival Fragrance Guide
          </p>
          <h1 className="mt-3 font-serif text-3xl md:text-6xl leading-tight max-w-4xl">
            {page.title}
          </h1>
          <p className="mt-4 md:mt-5 max-w-3xl text-[15px] md:text-lg text-muted-foreground">
            {page.intro}
          </p>
          <div className="mt-4 rounded-md border border-border bg-card p-4 max-w-3xl">
            <p className="text-[10px] md:text-[11px] uppercase tracking-[0.18em] text-muted-foreground mb-2">
              Quick Answer
            </p>
            <p className="text-sm text-muted-foreground">
              For {page.festivalName}, pick a{" "}
              {page.styleKeywords.slice(0, 2).join(" and ")} profile with 8-10
              hour comfort in Indian weather. Start with balanced projection
              fragrances and choose richer notes for evening events.
            </p>
          </div>
          ...
          <div className="mt-8 md:mt-10 grid gap-4 md:gap-6 md:grid-cols-3">
            <div className="rounded-xl md:rounded-2xl border border-border bg-card p-4 md:p-5">
              <p className="text-[10px] md:text-xs uppercase tracking-[0.2em] md:tracking-[0.22em] text-muted-foreground">
                Primary Intent
              </p>
              <p className="mt-2 text-[15px] md:text-base font-medium">
                Festival-ready perfume recommendations
              </p>
            </div>
            <div className="rounded-xl md:rounded-2xl border border-border bg-card p-4 md:p-5">
              <p className="text-[10px] md:text-xs uppercase tracking-[0.2em] md:tracking-[0.22em] text-muted-foreground">
              ...
              <p className="mt-2 text-[15px] md:text-base font-medium">
                Comfortable 8–10 hour wear in Indian weather
              </p>
            </div>
            <div className="rounded-xl md:rounded-2xl border border-border bg-card p-4 md:p-5">
              <p className="text-[10px] md:text-xs uppercase tracking-[0.2em] md:tracking-[0.22em] text-muted-foreground">
            ...
            <div className="flex items-end justify-between gap-4 mb-6">
              <div>
                ...
                <h2 className="mt-2 font-serif text-4xl">
                  Perfume picks for {page.festivalName}
                </h2>
              </div>
              <Link
                href="/shop"
                className="text-sm uppercase tracking-[0.18em] border-b border-foreground/20 pb-1 hover:border-foreground"
              >
                Shop All
              </Link>
            </div>
            ...
            {useSpotlightLayout ? (
              <div className="grid gap-6 lg:grid-cols-[340px_1fr] items-start">
                <div className="relative aspect-square overflow-hidden rounded-xl border border-border bg-card">
                  <Image
                    src={withCloudinaryTransforms(spotlightImage, {
                      width: 680,
                    })}
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-2">
            ...
            >
              <p className="text-sm font-medium">
                Explore HUME Special collection
              </p>
              <p className="mt-1 text-xs text-muted-foreground">
                Discover premium featured fragrances
              </p>
            </Link>
            <Link
              href="/bestseller"
        ...
        <div className="container-custom max-w-4xl space-y-6 px-4 sm:px-6 lg:px-10">
          ...
          <div className="rounded-2xl border border-border bg-foreground text-background p-6 md:p-8">
            ...
            <h2 className="mt-2 font-serif text-3xl">
              Find your {page.festivalName} signature scent
            </h2>
            <p className="mt-2 text-sm text-background/80">
              Shop HUME perfumes designed for Indian conditions with premium

  ...
  try {
    ...
    if (resendApiKey && fromEmail) {
      ...
      const sendResult = await resend.emails.send({
        ...
        text: `Welcome to HUME Fragrance.\n\nYour starting coupon code is ${couponCode}.\nUse it during checkout.\n\nNeed help choosing? Reply to this email or WhatsApp us at +91 95590 24822.`,
        html: `<div style="font-family:Arial,sans-serif;line-height:1.6;color:#111">
  <p>Welcome to <strong>HUME Fragrance</strong>.</p>
  <p>Your starting coupon code is:</p>
  <p style="font-size:22px;letter-spacing:2px;font-weight:700">${couponCode}</p>
  <p>Use this code during checkout.</p>
  <p>Need help? WhatsApp us: <a href="https://wa.me/919559024822">+91 95590 24822</a></p>
</div>`,
      });
